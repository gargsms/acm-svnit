...
function animateStrips () {
	...
	if(document.getElementById('picsContainer')) {
		document.getElementById('picsContainer').style.cssText = 'background-image:url(\'./img/stripe.jpg\');background-position:'+ posterId++*800 +'px 0px';
		timeout = setTimeout('animateStrips()', 5000);
	}
}

//psuedo-standard functions below
